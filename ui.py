...
with controls_col:
    ...
    provider = st.selectbox(
        "Assistant engine",
        ["auto", "open_source", "ollama", "open_llm", "hf_local", "openai", "rules"],
        index=0,
        help="Auto uses OpenAI when available, then the configured open-source stack, then the built-in SAP runbooks.",
    )
